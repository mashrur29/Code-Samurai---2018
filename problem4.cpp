...
void print_path(vector<pair<pair<pair<string, string>, pair<int, int> >, ll > > tmp, string lat1, string lon1, string lat2, string lon2, int case_src, int case_dst) {
	...
	for (int i = 0; i < tmp.size() - 1; i++) {
		...
		if(type == 0) {
			...
			string str1=start_name;
			string str2=endd_name;
			cout<<"Ride Metro from "<<" ("<<tmp[i].first.first.first<<", "<< tmp[i].first.first.second<<") ";
			cout<<" to "<<" ("<<tmp[i+1].first.first.first<<", "<< tmp[i+1].first.first.second<<") "<<endl;	
		}
		else if(type == 2) {
			...
			string str1=start_name;
			string str2=endd_name;
			cout<<"Ride Bikolpo Bus from "<<" ("<<tmp[i].first.first.first<<", "<< tmp[i].first.first.second<<") ";
			cout<<" to "<<" ("<<tmp[i+1].first.first.first<<", "<< tmp[i+1].first.first.second<<") "<<endl;	
		}
		else {
			...
			string str1=start_name;
			string str2=endd_name;
			cout<<"Ride Uttara Bus from "<<" ("<<tmp[i].first.first.first<<", "<< tmp[i].first.first.second<<") ";
			cout<<" to "<<" ("<<tmp[i+1].first.first.first<<", "<< tmp[i+1].first.first.second<<") "<<endl;	
		}
